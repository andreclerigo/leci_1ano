...
-- *****************************************************************************
-- Generated on "03/25/2020 11:26:46"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          FreqDivider_Demo
-- 
...
ENTITY FreqDivider_Demo_vhd_vec_tst IS
END FreqDivider_Demo_vhd_vec_tst;
ARCHITECTURE FreqDivider_Demo_arch OF FreqDivider_Demo_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL CLOCK_50 : STD_LOGIC;
SIGNAL k : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL LEDR : STD_LOGIC_VECTOR(0 DOWNTO 0);
COMPONENT FreqDivider_Demo
	PORT (
